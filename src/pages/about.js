...
function About() {
  return (
    <>
      <Head>
        <title>About Us | ChatWithPDF.AI</title>
        <meta name="description" content="About Us of ChatWithPDF.AI" />
